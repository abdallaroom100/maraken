...
const AddAdvance = () => {
  ...
  }, [searchQuery, selectedWorker, token]);
    ...
    return (
      <div className="add-advance-container">
        <div className="access-denied">
          ...
          <p>هذه الصفحة متاحة للأدمن العادي فقط</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="add-advance-container">
      ...
      <div className="add-advance-form-container">
        <form onSubmit={handleSubmit} className="add-advance-form">
          {/* Worker Search */}
          <div className="form-group">
            ...
            <div className="search-container" ref={dropdownRef}>
              ...
              {showDropdown && workers.length > 0 && (
                <div className="workers-dropdown relative">
                  {selectedWorker && (
                <button
                  type="button"
